...
def parse_agrs():
    ...
    parser.add_argument('--save_dir', type=str, default='/content/drive/MyDrive/example_data/Results/', help='the patch to save the models.')
...
def main():
    ...
    model = CT2RepLongModel(args, tokenizer)
